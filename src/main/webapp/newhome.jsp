...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="newhome.html">Home <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
      ...
      <div class="overlay" id="availabilityOverlay">
        <div class="overlay-content">
<form class="reservation-form" id="availabilityForm" method="get" action="AvailabilityServlet">
            <div class="form-row">
                ...
                <input type="hidden" id="checkinDateHidden" name="checkinDate" value="">
    <input type="hidden" id="checkoutDateHidden" name="checkoutDate" value="">
    <input type="hidden" id="roomTypeHidden" name="roomType" value="">
            </div>
            <button type="submit" class="btn btn-primary" onclick="checkAvailability()">Check Availability</button>
        </form>
        </div>
    </div>
    </div>
      ...
      <div class="card-deck">
        <div class="card">
          ...
          <div class="card-footer">
            <a class="btn btn-primary" href="CustomerLogin.jsp" role="button">BOOK NOW</a>
          </div>
        </div>
        <div class="card">
          <img class="card-img-top" src="./images/hotel_feture_2.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Basic single Room</h5>
            <p class="card-text">24 hours air conditioning with free wifi and room service</p>
          </div>
          <div class="card-footer">
            <a class="btn btn-primary" href="CustomerLogin.jsp" role="button">BOOK NOW</a>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <h5 class="card-title">Basic double Room</h5>
            <p class="card-text">24 hours air conditioning with free wifi and room service</p>
          </div>
          <div class="card-footer">
            <a class="btn btn-primary" href="CustomerLogin.jsp" role="button">BOOK NOW</a>
...
<script>
   function checkAvailability() {
      ...
      document.getElementById('checkoutDateHidden').value = checkoutDate;
      document.getElementById('roomTypeHidden').value = roomType;
